...
const makeNewsletterSocket = (config) => {
  ...
  const parseFetchedUpdates = async (node, type) => {
    ...
    return await Promise.all(
      (0, WABinary_1.getAllBinaryNodeChildren)(child).map(
        async (messageNode) => {
          var _a, _b;
          messageNode.attrs.from =
            child === null || child === void 0 ? void 0 : child.attrs.jid;
          const views = parseInt(
            ((_b =
              (_a = (0, WABinary_1.getBinaryNodeChild)(
                messageNode,
                "views_count",
              )) === null || _a === void 0
                ? void 0
          ...
          if (type === "messages") {
            const { fullMessage: message, decrypt } = await (0,
  ...
  return {
    ...
    subscribeNewsletterUpdates: async (jid) => {
      ...
      return (_a = (0, WABinary_1.getBinaryNodeChild)(
        result,
        "live_updates",
      )) === null || _a === void 0
        ? void 0
      ...
      const result = await newsletterWMexQuery(
        ...
        Types_1.QueryIds.CREATE,
        {
          input: {
            ...
            description,
            settings: {
              reaction_codes: { value: reaction_codes.toUpperCase() },
            },
          },
        },
      );
    ...
    newsletterAdminCount: async (jid) => {
      ...
      const buff =
        (_b =
          (_a = (0, WABinary_1.getBinaryNodeChild)(result, "result")) ===
            null || _a === void 0
            ? void 0
