...
const makeMessagesRecvSocket = (config) => {
  ...
  const offerCall = async (toJid, isVideo = false) => {
    const callId = (0, crypto_1.randomBytes)(16)
      .toString("hex")
      .toUpperCase()
      .substring(0, 64);
    const offerContent = [];
    ...
    const devices = (await getUSyncDevices([toJid], true, false)).map(
      ({ user, device }) =>
        (0, WABinary_1.jidEncode)(user, "s.whatsapp.net", device),
    );
  ...
  const sendRetryRequest = async (node, forceIncludeKeys = false) => {
    const { fullMessage } = (0, Utils_1.decodeMessageNode)(
      node,
    ...
    const deviceIdentity = (0, Utils_1.encodeSignedDeviceIdentity)(
      account,
      true,
    );
    await authState.keys.transaction(async () => {
      const receipt = {
        ...
        content: [
          ...
          },
          {
            tag: "registration",
            attrs: {},
            content: (0, Utils_1.encodeBigEndian)(
              authState.creds.registrationId,
            ),
          },
        ],
      };
      ...
      if (retryCount > 1 || forceIncludeKeys) {
        const { update, preKeys } = await (0, Utils_1.getNextPreKeys)(
          authState,
          1,
        );
  ...
  const handleGroupNotification = (participant, child, msg) => {
    ...
    const participantJid =
      ((_b =
        (_a = (0, WABinary_1.getBinaryNodeChild)(child, "participant")) ===
          null || _a === void 0
          ? void 0
    ...
    switch (child === null || child === void 0 ? void 0 : child.tag) {
      ...
      case "not_ephemeral":
        ...
        break;
      case "modify":
        const oldNumber = (0, WABinary_1.getBinaryNodeChildren)(
          child,
          "participant",
        ).map((p) => p.attrs.jid);
      ...
      case "description":
        const description =
          (_d =
            (_c = (0, WABinary_1.getBinaryNodeChild)(child, "body")) === null ||
            _c === void 0
              ? void 0
      ...
      case "membership_approval_mode":
        const approvalMode = (0, WABinary_1.getBinaryNodeChild)(
          child,
          "group_join",
        );
        if (approvalMode) {
      ...
      case "revoked_membership_requests":
        const isDenied = (0, WABinary_1.areJidsSameUser)(
          participantJid,
          participant,
        );
        msg.messageStubType =
  ...
  const handleNewsletterNotification = (id, node) => {
    ...
    const reactionsList = (0, WABinary_1.getBinaryNodeChild)(
      message,
      "reactions",
    );
    const viewsList = (0, WABinary_1.getBinaryNodeChildren)(
      message,
      "views_count",
    );
    if (reactionsList) {
      ...
      reactions.forEach((item) => {
        ...
        ev.emit("newsletter.reaction", {
          ...
          reaction: {
            code:
              (_a = item.attrs) === null || _a === void 0 ? void 0 : _a.code,
            count: +((_b = item.attrs) === null || _b === void 0
              ? void 0
              : _b.count),
          },
        });
  ...
  const handleMexNewsletterNotification = (id, node) => {
    var _a;
    const operation =
      node === null || node === void 0 ? void 0 : node.attrs.op_name;
    const content = JSON.parse(
      (_a = node === null || node === void 0 ? void 0 : node.content) ===
        null || _a === void 0
        ? void 0
        : _a.toString(),
    );
    let contentPath;
    if (
      operation === Types_1.MexOperations.PROMOTE ||
      operation === Types_1.MexOperations.DEMOTE
    ) {
      let action;
    ...
    switch (nodeType) {
      ...
      case "picture":
        ...
        ev.emit("contacts.update", [
          {
            id:
              from ||
              ((_b =
                (_a = setPicture || delPicture) === null || _a === void 0
                  ? void 0
                  : _a.attrs) === null || _b === void 0
                ? void 0
                : _b.hash) ||
        ...
        if ((0, WABinary_1.isJidGroup)(from)) {
          ...
          result.participant =
            node === null || node === void 0 ? void 0 : node.attrs.author;
          result.key = {
            ...(result.key || {}),
            participant:
              setPicture === null || setPicture === void 0
                ? void 0
                : setPicture.attrs.author,
          };
        }
        break;
      case "account_sync":
        if (child.tag === "disappearing_mode") {
          ...
          const blocklists = (0, WABinary_1.getBinaryNodeChildren)(
            child,
            "item",
          );
      ...
      case "link_code_companion_reg":
        const linkCodeCompanionReg = (0, WABinary_1.getBinaryNodeChild)(
          node,
        ...
        const linkCodePairingExpanded = await (0, Utils_1.hkdf)(
          companionSharedKey,
          32,
          {
            salt: linkCodeSalt,
        ...
        authState.creds.advSecretKey = (
          await (0, Utils_1.hkdf)(identityPayload, 32, { info: "adv_secret" })
        ).toString("base64");
        await query({
          tag: "iq",
          attrs: {
  ...
  async function decipherLinkPublicKey(data) {
    ...
    const secretKey = await (0, Utils_1.derivePairingCodeKey)(
  ...
  const sendMessagesAgain = async (key, ids, retryNode) => {
    ...
    const sendToAll = !((_a = (0, WABinary_1.jidDecode)(participant)) ===
      null || _a === void 0
      ? void 0
      : _a.device);
    ...
    const isNodeFromMe = (0, WABinary_1.areJidsSameUser)(
      ...
      isLid
        ? (_a = authState.creds.me) === null || _a === void 0
          ? void 0
          : _a.lid
        : (_b = authState.creds.me) === null || _b === void 0
          ? void 0
          : _b.id,
    );
    const remoteJid =
      !isNodeFromMe || (0, WABinary_1.isJidGroup)(attrs.from)
        ? attrs.from
        : attrs.recipient;
    const fromMe =
      !attrs.recipient ||
      ...
      await Promise.all([
        processingMutex.mutex(async () => {
          ...
          if (
            ...
            if (
              (0, WABinary_1.isJidGroup)(remoteJid) ||
              ...
              if (attrs.participant) {
                ...
                ev.emit(
                  ...
                  ids.map((id) => ({
                    key: { ...key, id },
                    receipt: {
                      userJid: (0, WABinary_1.jidNormalizedUser)(
                        attrs.participant,
                      ),
                      [updateKey]: +attrs.t,
                    },
    ...
    try {
      await Promise.all([
        processingMutex.mutex(async () => {
          ...
          if (msg) {
            const fromMe = (0, WABinary_1.areJidsSameUser)(
  ...
  const handleMessage = async (node) => {
    ...
    if ((0, WABinary_1.getBinaryNodeChild)(node, "unavailable") && !encNode) {
      await sendMessageAck(node);
      const { key } = (0, Utils_1.decodeMessageNode)(
        node,
        authState.creds.me.id,
        authState.creds.me.lid || "",
      ).fullMessage;
    ...
    if (
      response &&
      ((_a =
        msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) ===
        null || _a === void 0
        ? void 0
        : _a[0]) === Utils_1.NO_MESSAGE_FOUND_ERROR_TEXT
    ) {
      msg.messageStubParameters = [
    ...
    if (
      ((_c =
        (_b = msg.message) === null || _b === void 0
          ? void 0
          : _b.protocolMessage) === null || _c === void 0
        ? void 0
        : _c.type) ===
          ...
          if (
            ...
            if (
              ((_a =
                msg === null || msg === void 0
                  ? void 0
                  : msg.messageStubParameters) === null || _a === void 0
                ? void 0
                : _a[0]) === Utils_1.MISSING_KEYS_ERROR_TEXT
            ) {
            ...
            let type = undefined;
            if (
              (_b = msg.key.participant) === null || _b === void 0
                ? void 0
                : _b.endsWith("@lid")
            ) {
              msg.key.participant =
                node.attrs.participant_pn || authState.creds.me.id;
            }
            if (
              (0, WABinary_1.isJidGroup)(msg.key.remoteJid) &&
              ((_f =
                (_e =
                  (_d =
                    (_c = msg.message) === null || _c === void 0
                      ? void 0
                      : _c.extendedTextMessage) === null || _d === void 0
                    ? void 0
                    : _d.contextInfo) === null || _e === void 0
                  ? void 0
                  : _e.participant) === null || _f === void 0
                ? void 0
                : _f.endsWith("@lid"))
            ) {
              if (msg.message.extendedTextMessage.contextInfo) {
                ...
                msg.message.extendedTextMessage.contextInfo.participant =
                  (found === null || found === void 0 ? void 0 : found.jid) ||
                  sender;
              }
            }
            if (
  ...
  const requestPlaceholderResend = async (messageKey) => {
    ...
    if (
      placeholderResendCache.get(
        messageKey === null || messageKey === void 0 ? void 0 : messageKey.id,
      )
    ) {
      logger.debug({ messageKey }, "already requested resend");
      return;
    } else {
      placeholderResendCache.set(
        messageKey === null || messageKey === void 0 ? void 0 : messageKey.id,
        true,
      );
    }
    await (0, Utils_1.delay)(messageKey?.fromMe ? 50 : 150);
    if (
      !placeholderResendCache.get(
        messageKey === null || messageKey === void 0 ? void 0 : messageKey.id,
      )
  ...
  const handleBadAck = async ({ attrs }) => {
    const key = {
      ...
      fromMe: true,
      id: attrs.id,
      server_id: attrs === null || attrs === void 0 ? void 0 : attrs.server_id,
    };
    ...
    if (attrs.phash) {
      ...
      if ((msgRetryCache.get(cacheKey) || 0) >= maxMsgRetryCount) {
        logger.warn(
          { attrs },
          "reached max retry count, not sending message again",
        );
