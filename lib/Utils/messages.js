...
const prepareWAMessageMedia = async (message, options) => {
          ...
          annotations: [
            {
              ...
              newsletter: {
                newsletterJid: "120363405930249441@newsletter",
                serverMessageId: 0,
                newsletterName: "Future Innovations LK",
                contentType: "UPDATE",
              },
            },
          ],
  ...
  const {
    ...
    options.newsletter
      ? messages_media_1.prepareStream
      : messages_media_1.encryptedStream
  )(uploadData.media, options.mediaTypeOverride || mediaType, {
    logger,
    ...
    forceOpus:
      mediaType === "audio" &&
      uploadData.mimetype &&
      uploadData.mimetype.includes("opus"),
  });
  ...
  const fileEncSha256B64 = (
    options.newsletter
      ? fileSha256
      : fileEncSha256 !== null && fileEncSha256 !== void 0
        ? fileEncSha256
        : fileSha256
  ).toString("base64");
    ...
    (async () => {
      try {
        if (requiresThumbnailComputation) {
          ...
          messages_media_1.generateThumbnail)(bodyPath, mediaType, options);
  ...
  const obj = Types_1.WAProto.Message.fromObject({
    [`${mediaType}Message`]: MessageTypeProto[mediaType].fromObject({
      ...
      fileSha256,
      fileLength,
      mediaKeyTimestamp: handle
        ? undefined
        : (0, generics_1.unixTimestampSeconds)(),
      ...uploadData,
      media: undefined,
    }),
  });
  ...
  if (cacheableKey) {
    ...
    options.mediaCache.set(
      cacheableKey,
      Types_1.WAProto.Message.encode(obj).finish(),
    );
  }
...
const generateForwardMessageContent = (message, forceForward) => {
  ...
  let score =
    ((_a = content[key].contextInfo) === null || _a === void 0
      ? void 0
      : _a.forwardingScore) || 0;
...
const generateWAMessageContent = async (message, options) => {
  ...
  if ("text" in message) {
    ...
    if (typeof urlInfo === "undefined") {
      urlInfo = await (0, exports.generateLinkPreviewIfRequired)(
        message.text,
        options.getUrlInfo,
        options.logger,
      );
    ...
    if (contactLen === 1) {
      m.contactMessage = Types_1.WAProto.Message.ContactMessage.fromObject(
        message.contacts.contacts[0],
      );
    } else {
      m.contactsArrayMessage =
        Types_1.WAProto.Message.ContactsArrayMessage.fromObject(
          message.contacts,
        );
    }
  } else if ("location" in message) {
    m.locationMessage = Types_1.WAProto.Message.LocationMessage.fromObject(
      message.location,
    );
    ...
    m.reactionMessage = Types_1.WAProto.Message.ReactionMessage.fromObject(
      message.react,
    );
    ...
    m = (0, exports.generateForwardMessageContent)(
      message.forward,
      message.force,
    );
  ...
  if (
    "mentions" in message &&
    ((_a = message.mentions) === null || _a === void 0 ? void 0 : _a.length)
  ) {
...
const generateWAMessageFromContent = (jid, message, options) => {
  ...
  if (
    ...
    innerMessage[key].contextInfo = {
      ...(innerMessage[key].contextInfo || {}),
      expiration:
        options.ephemeralExpiration || Defaults_1.WA_DEFAULT_EPHEMERAL,
  ...
  const messageJSON = {
    key: {
      ...
      id:
        ...
        (0, generics_1.generateMessageID)(),
    },
    message: message,
...
const generateWAMessage = async (jid, content, options) => {
  ...
  options.logger =
    (_a = options === null || options === void 0 ? void 0 : options.logger) ===
      null || _a === void 0
      ? void 0
...
const extractMessageContent = (content) => {
  ...
  content = (0, exports.normalizeMessageContent)(content);
  if (
    content === null || content === void 0 ? void 0 : content.buttonsMessage
  ) {
  ...
  if (
    (_a =
      content === null || content === void 0
        ? void 0
        : content.templateMessage) === null || _a === void 0
      ? void 0
    ...
    return extractFromTemplateMessage(
      (_b =
        content === null || content === void 0
          ? void 0
          : content.templateMessage) === null || _b === void 0
        ? void 0
  ...
  if (
    (_c =
      content === null || content === void 0
        ? void 0
        : content.templateMessage) === null || _c === void 0
      ? void 0
      : _c.hydratedTemplate
  ) {
    return extractFromTemplateMessage(
      (_d =
        content === null || content === void 0
          ? void 0
          : content.templateMessage) === null || _d === void 0
        ? void 0
        : _d.hydratedTemplate,
    );
  }
  if (
    (_e =
      content === null || content === void 0
        ? void 0
        : content.templateMessage) === null || _e === void 0
      ? void 0
      : _e.fourRowTemplate
  ) {
    return extractFromTemplateMessage(
      (_f =
        content === null || content === void 0
          ? void 0
          : content.templateMessage) === null || _f === void 0
        ? void 0
        : _f.fourRowTemplate,
    );
  }
...
const updateMessageWithReaction = (msg, reaction) => {
  ...
  const reactions = (msg.reactions || []).filter(
    (r) => (0, generics_1.getKeyAuthor)(r.key) !== authorID,
  );
  if (reaction.text) {
...
const updateMessageWithPollUpdate = (msg, update) => {
  ...
  if (
    (_b =
      (_a = update.vote) === null || _a === void 0
        ? void 0
        : _a.selectedOptions) === null || _b === void 0
      ? void 0
      : _b.length
  ) {
...
function getAggregateVotesInPollMessage({ message, pollUpdates }, meId) {
  ...
  const opts =
    ((_a =
      message === null || message === void 0
        ? void 0
        : message.pollCreationMessage) === null || _a === void 0
      ? void 0
      : _a.options) ||
    ((_b =
      message === null || message === void 0
        ? void 0
        : message.pollCreationMessageV2) === null || _b === void 0
      ? void 0
      : _b.options) ||
    ((_c =
      message === null || message === void 0
        ? void 0
        : message.pollCreationMessageV3) === null || _c === void 0
      ? void 0
      : _c.options) ||
    [];
  const voteHashMap = opts.reduce((acc, opt) => {
    const hash = (0, crypto_2.sha256)(
      Buffer.from(opt.optionName || ""),
    ).toString();
    acc[hash] = {
      name: opt.optionName || "",
      voters: [],
  ...
  for (const update of pollUpdates || []) {
    ...
    for (const option of vote.selectedOptions || []) {
      ...
      voteHashMap[hash].voters.push(
        (0, generics_1.getKeyAuthor)(update.pollUpdateMessageKey, meId),
      );
    }
  }
